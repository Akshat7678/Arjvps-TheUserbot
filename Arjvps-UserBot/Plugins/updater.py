"""
This module is used for updating `Arjvps UserBot`
"""
...
GIT_REPO_NAME = "Arjvps-TheUserbot"
UPSTREAM_REPO_URL = "https://github.com/Akshat7678/Arjvps-TheUserbot"
...
async def upstream(ups):
    ...
    if ac_br != "master":
        await ups.edit(
            ...
            "Please checkout the official branch of Arjvps`"
        )
        repo.__del__()
        return
