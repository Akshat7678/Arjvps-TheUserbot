...
async def install(event):
    ...
    OUTPUT = (
        OUTPUT
    ) = f"Here is the list of plugins found in 'master' branch of Arjvps.\n{o}\n\nUse `.help <cmd_name>` to learn how a paticular plugin works.\nJoin @ArjvpsUserBot_SupportChannel for help!"
    ...
    await tele.edit(
        f"`All plugins available in` **Arjvps** `can be found` [here]({url})!!"
    )
