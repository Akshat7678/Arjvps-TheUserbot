    ...
    if LOAD_MYBOT == "False":
        ...
        if BOT_PIC:
            await tgbot.send_file(event.chat_id,
                                  ...
                                  buttons=[
                                      [Button.url(
                                          "ARJVPS Userbot", url="https://github.com/Akshat7678/Arjvps-TheUserbot")],
                                      [Button.inline(
...
async def owner(event):
    await tgbot.send_message(event.chat_id,
                             ...
                             buttons=[
                                 [Button.inline(
                                     "ArjvpsSetting ⚙️", data="settings"),
                                  Button.inline(
                                     "SystemStat 👨‍💻", data="stats")],
                                 [Button.inline("Broadcast",
                                                data="telebroad")],
                                 [Button.url("Support",
                                             url="https://t.me/ArjvpsUserBot_SupportChannel")]
                             ])
...
async def logs(event):
    ...
    await tgbot.send_file(
        ...
        buttons=[
            ...
            [Button.url("Crashed?", "t.me/ArjvpsUserBot_SupportChannel")]
        ])
...
async def settings(event):
    await event.edit("Browse through the available options:",
                     buttons=[
                         [(Button.url("Repository", url="https://github.com/Akshat7678/Arjvps-TheUserbot")),
                          (Button.url("Deploy", url="https://dashboard.heroku.com/new?button-url=https%3A%2F%2Fgithub.com%2FAkshat7678%2FArjvps-TheUserBot%2F&template=https%3A%2F%2Fgithub.com%2FAkshat7678%2FArjvps-TheUserBot"))],
                         [Button.url("Support",
